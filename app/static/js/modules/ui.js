    ...
    <div class="bg-white rounded-lg shadow p-6">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <div>
          ...
          <p class="font-semibold text-gray-800">${cliente.nombre} ${
    cliente.apellido
  }</p>
        </div>
  ...
  const prestamosHTML = prestamos
    ...
    <div class="bg-white rounded-lg shadow p-6 hover:shadow-lg transition-shadow">
      <div class="flex justify-between items-start mb-4">
        <div>
          <h4 class="text-lg font-semibold text-gray-800">Préstamo #${
            prestamo.id
          }</h4>
      ...
      <div class="grid grid-cols-2 gap-4 mb-4">
        <div>
          ...
          <p class="text-lg font-bold text-gray-800">S/ ${prestamo.monto.toFixed(
            2
          )}</p>
        </div>
        <div>
        ...
        <div>
          ...
          <p class="text-lg font-bold text-gray-800">S/ ${prestamo.deuda_total.toFixed(
            2
          )}</p>
        </div>
      </div>
